function GetPluginSettings()
{
	return {
		...
		"version":		"1.1.0",					// (float in x.y format) Plugin version - C2 shows compatibility warnings based on this
		"description":	"show leaderboard and achievements. (google play game and game center, SDK)",
		"author":		"cranberrygame - edited by Fred Oliveira",
		"help url":		"https://guimaraf.github.io/devlog/googleplaygames.html?referrer=edittime.js",
		...
		"cordova-plugins":	"https://github.com/guimaraf/cordova-plugin-game --variable APP_ID='YOUR_GOOGLE_PLAY_GAME_APP_ID'",		
